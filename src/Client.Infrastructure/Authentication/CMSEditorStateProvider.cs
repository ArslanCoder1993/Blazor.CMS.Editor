...
namespace Blazor.CMS.Editor.Client.Infrastructure.Authentication
{
    public class CMSEditorStateProvider : AuthenticationStateProvider
    {
        private readonly HttpClient _httpClient;
        private readonly ILocalStorageService _localStorage;

        public CMSEditorStateProvider(
