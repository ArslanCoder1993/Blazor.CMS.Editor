...
using Blazor.CMS.Editor.Client.Infrastructure.Routes;
using Blazor.CMS.Editor.Shared.Constants.Storage;
    ...
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await ((CMSEditorStateProvider)this._authenticationStateProvider).StateChangedAsync();
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((CMSEditorStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
