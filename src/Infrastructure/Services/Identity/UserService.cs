...
using AutoMapper;
using Blazor.CMS.Editor.Application.Exceptions;
using Blazor.CMS.Editor.Application.Extensions;
...
using Blazor.CMS.Editor.Infrastructure.Specifications;
using Blazor.CMS.Editor.Shared.Constants.Role;
...
namespace Blazor.CMS.Editor.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        private readonly UserManager<CMSEditorUser> _userManager;
        private readonly RoleManager<CMSEditorRole> _roleManager;
        ...
        public UserService(
            UserManager<CMSEditorUser> userManager,
            IMapper mapper,
            RoleManager<CMSEditorRole> roleManager,
        ...
        private async Task<string> SendVerificationEmail(CMSEditorUser user, string origin)
        {
        ...
        public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
            ...
            if (user.Email == "Miguel@CMSEditor.com")
            {
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
                mappers: new Dictionary<string, Func<CMSEditorUser, object>>
                {
