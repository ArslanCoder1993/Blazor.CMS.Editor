...
namespace Blazor.CMS.Editor.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        private readonly SignInManager<CMSEditorUser> _signInManager;
        private readonly IStringLocalizer<IdentityService> _localizer;

        public IdentityService(
            UserManager<CMSEditorUser> userManager, RoleManager<CMSEditorRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<CMSEditorUser> signInManager,
        ...
        private async Task<string> GenerateJwtAsync(CMSEditorUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(CMSEditorUser user)
        {
